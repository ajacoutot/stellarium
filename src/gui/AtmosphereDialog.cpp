...
void AtmosphereDialog::createDialogContent()
{
	...
	connectBoolProperty(ui->checkBox_blendSun, "StelSkyDrawer.useSunBlending");
	connectBoolProperty(ui->checkBox_drawSunAfterAtmosphere, "StelSkyDrawer.drawSunAfterAtmosphere");
