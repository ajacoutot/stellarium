...
class StelSkyDrawer : public QObject, protected QOpenGLFunctions
{
	...
	Q_PROPERTY(bool drawSunAfterAtmosphere READ getDrawSunAfterAtmosphere WRITE setDrawSunAfterAtmosphere NOTIFY flagDrawSunAfterAtmosphereChanged)
	Q_PROPERTY(bool useSunBlending READ getUseSunBlending WRITE setUseSunBlending NOTIFY flagUseSunBlendingChanged)
...
signals:
	...
	void turbidityChanged(double newT);
